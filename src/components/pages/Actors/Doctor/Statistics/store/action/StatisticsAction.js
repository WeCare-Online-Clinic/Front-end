...
export const ON_GET_PATIENTS_DIOGNOSIS_COUNT = [
...
export function getDataCardDetails(doctorId) {
  const request = StatisticsService.getDataCardDetails(doctorId)
...
export function getDiagnosis(clinicId) {
  const request = StatisticsService.getDiagnosis(clinicId)
  return (dispatch, getState) => {
    request
      .then((response) => {
...
export function getPatientAge(clinicId) {
  const request = StatisticsService.getPatientAge(clinicId)
  return (dispatch, getState) => {
    request
      .then((response) => {
...
export function getPatientCountInClinic(clinicId) {
  const request = StatisticsService.getPatientCountInClinic(clinicId)
  return (dispatch, getState) => {
    request
      .then((response) => {
...
export function getConsultedPatientsData(doctorId) {
  const request = StatisticsService.getConsultedPatientsData(doctorId)
  return (dispatch, getState) => {
    request
      .then((response) => {
