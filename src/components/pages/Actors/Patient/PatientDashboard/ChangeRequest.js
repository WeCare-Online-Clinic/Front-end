...
const ChangeRequest = (props) => {
  ...
  const reducerData = useSelector(
    ({ requestDates }) => requestDates.patientDashboard
  )
  ...
  const currentClinicDate =
    nextClinic.clinicAppointment.clinicDate &&
    nextClinic.clinicAppointment.clinicDate.date
  const sendRequest = () => {
    let requestObject = Object.assign(
      {},
      {
        clinic: nextClinic.clinic,
        patient: nextClinic.clinicAppointment.patient,
        clinicDate: nextClinic.clinicAppointment.clinicDate,
      }
    ) //requestdate object
