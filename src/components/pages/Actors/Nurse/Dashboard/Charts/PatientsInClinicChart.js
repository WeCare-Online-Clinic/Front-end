...
const PatientsInClinicChart = () => {
  const reducerData = useSelector(({ npatientInClinic }) => npatientInClinic.nurseDashboard);
...
export default withReducer('npatientInClinic', reducer)(PatientsInClinicChart);
