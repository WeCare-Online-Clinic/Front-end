...
const ConsultedPatientChart = () => {
  const reducerData = useSelector(({ nconsultedPatients }) => nconsultedPatients.nurseDashboard);
...
export default withReducer('nconsultedPatients', reducer)(ConsultedPatientChart);
