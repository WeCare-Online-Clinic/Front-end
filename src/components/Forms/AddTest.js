    ...
    return (<div className="signup">     
                        ...
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <form >
                                 ...
                                 <p className="text-center">Field 1</p><hr></hr>
                                 <div className="input-group mb-3">
                                ...
                                <div className="input-group mb-3">
                                    <span className="input-group-text">Measurements</span>
                                        <select>
                                 ...
                                 <div className="input-group mb-3">
                                    <span className="input-group-text">Test Holder</span>
                                 ...
                                 <p className="text-center">Field 2</p><hr></hr>
                                 <div className="input-group mb-3">
                                    <span className="input-group-text">Name</span>
                                    <input placeholder="Name" 
                                           name="fieldname" 
                                ...
                                <div className="input-group mb-3">
                                 ...
                                 <p className="text-center">Field 3</p><hr></hr>
                                 <div className="input-group mb-3">
                                    <span className="input-group-text">Name</span>
                                    <input placeholder="Name" 
                                           name="fieldname" 
