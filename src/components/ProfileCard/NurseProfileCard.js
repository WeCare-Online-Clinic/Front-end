    ...
    <Card className={classes.card}>
      ...
      <CardContent>
        <Grid container>
          ...
          <Grid item sm={6}>
            <div className={classes.textField}>: 378204896</div>
            <div className={classes.textField}>: BSN</div>
            <div className={classes.textField}>: 0773618967</div>
            <div className={classes.textField}>: nurse@gmail.com</div>
